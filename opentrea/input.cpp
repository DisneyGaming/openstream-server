...
struct gamepad_t {
  ...
  // Afterwards, the gamepad state on opentrea won't match the state on Moonlight.
  // To prevent Opentrea from sending erronious input data to the active application,
  // Opentrea forces the button to be in a specific state until the gamepad state matches that of
  // Moonlight once more.
