...
struct gamepad_t {
  ...
  // Afterwards, the gamepad state on openstream won't match the state on Moonlight.
  // To prevent Openstream from sending erronious input data to the active application,
  // Openstream forces the button to be in a specific state until the gamepad state matches that of
  // Moonlight once more.
