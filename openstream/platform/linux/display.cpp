...
#include "openstream/task_pool.h"
#include "openstream/config.h"
...
std::unique_ptr<mic_t> microphone(std::uint32_t sample_rate) {
  ...
  mic->mic.reset(
    pa_simple_new(nullptr, "openstream", pa_stream_direction_t::PA_STREAM_RECORD, audio_sink, "sunshine-record", &mic->ss, nullptr, nullptr, &status)
  );
