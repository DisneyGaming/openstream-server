...
#ifndef OPENSTREAM_PROCESS_H
#define OPENSTREAM_PROCESS_H
 ...
 *    Command exits
 * cmd_output --
 *    empty    -- The output of the commands are appended to the output of openstream
